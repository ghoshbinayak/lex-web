...
* In this twoargument version, the first argument is the 
...
* It needs to be terminated at the command prompt with controlC 
* or the equivalent. 
* 
...
public class TimeServerPublisher { 
	public static void main(String[ ] args) {
		// 1st argument is the publication URL 
	 	...
	 	Endpoint.publish("http://127.0.0.1:5000/ts", 
	 	new TimeServerImpl());
	} 
}